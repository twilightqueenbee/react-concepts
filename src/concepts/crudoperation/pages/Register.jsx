    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-cyan-100">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleform} className="space-y-4">
          ...
          {/* Submit Button */}
          <button
            className="w-full py-2 text-white font-semibold rounded-md bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 transition"
          >
            Register
          </button>
